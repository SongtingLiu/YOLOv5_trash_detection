...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/Combined_trash.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'yolov5s_combined_trash.pt', help='model.pt path(s)')
